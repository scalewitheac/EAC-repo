...
const PrimaryButton = ({ href, children, testid, external = false }) => (
  <a
    ...
    className="btn-primary inline-flex items-center justify-center gap-2 bg-[#3B82F6] text-white font-semibold px-7 py-4 rounded-xl text-sm sm:text-base tracking-tight"
  >
    {children}
  </a>
);
    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-10 h-16 flex items-center justify-between">
      ...
      >
        <span className="relative inline-flex h-2.5 w-2.5">
          <span className="absolute inset-0 rounded-full bg-[#3B82F6] pulse-dot" />
          <span className="absolute inset-0 rounded-full bg-[#3B82F6]" />
        </span>
        <span className="font-display text-lg font-bold tracking-tight">
          Engage<span className="text-[#3B82F6]">Flow</span>
        </span>
      </a>
      <a
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="sm:hidden text-sm font-medium text-[#3B82F6]"
      >
        Book →
      </a>
    </div>
  ...
  >
    ...
    <div className="relative max-w-6xl mx-auto px-6 lg:px-10 text-center">
      ...
      >
        ...
        customer call <span className="text-[#3B82F6]">again.</span>
      </h1>
      ...
      >
        EngageFlow A.I. answers every call, books appointments, qualifies leads, and
  ...
  >
    ...
    <div className="relative max-w-6xl mx-auto px-6 lg:px-10">
      <div className="max-w-2xl">
        <div className="text-xs sm:text-sm tracking-[0.25em] uppercase text-[#3B82F6] font-semibold mb-5">
          The hidden cost
        </div>
        <h2
  ...
  >
    <div className="max-w-6xl mx-auto px-6 lg:px-10">
      <div className="max-w-2xl">
        ...
        <p className="mt-5 text-white/60 text-base sm:text-lg max-w-xl">
          EngageFlow A.I. handles the entire front desk — from first ring to booked
      ...
      <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-5">
        {FEATURES.map((f) => {
          ...
          return (
            ...
            >
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#3B82F6]/10 border border-[#3B82F6]/30 mb-6">
              ...
              <ArrowRight className="absolute top-8 right-8 h-5 w-5 text-white/20 group-hover:text-[#3B82F6] group-hover:translate-x-1 transition-all duration-300" />
            </div>
          );
        })}
      </div>
      ...
      <div className="mt-10 flex flex-wrap gap-3">
        {[
          ...
          >
            <I className="h-3.5 w-3.5 text-[#3B82F6]" />
            {label}
          </div>
        ))}
      </div>
  ...
  >
    ...
    <div className="relative max-w-4xl mx-auto px-6 lg:px-10 text-center">
      <h2
        ...
        className="font-display font-bold tracking-tighter text-white text-4xl sm:text-5xl lg:text-6xl leading-[1.02]"
      >
        Stop losing revenue to <span className="text-[#3B82F6]">missed calls.</span>
      </h2>
  ...
  >
    <div className="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <div className="text-xs text-white/40">
        © {new Date().getFullYear()} EngageFlow A.I. — Your AI receptionist that never sleeps.
      </div>
    </div>
  </footer>
);
